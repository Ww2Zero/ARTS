...
int main() {
    assertDeleteDuplicates(vector<int>{1, 1, 2, 3}, vector<int>{1, 2, 3});
    assertDeleteDuplicates(vector<int>{1, 1, 1, 1, 1, 1, 2, 3}, vector<int>{1, 2, 3});
    assertDeleteDuplicates(vector<int>{1, 1, 1, 1, 1, 1, 2, 3, 3, 3, 3}, vector<int>{1, 2, 3});
    return 0;
}